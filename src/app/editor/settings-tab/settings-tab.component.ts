...
@Component({
  ...
  standalone: true,
  imports: [ColorPickerComponent, SettingsSaveBarComponent, ColorsTabComponent, VariablesTabComponent, HlmInput, HlmButton, HlmTabs, HlmTabsList, HlmTabsTrigger, HlmTabsContent],
