      ...
      columns: [
        {
          ...
          blocks: [
            ...
            { id: uid(), type: 'social', props: {
              links: [
                { id: uid(), platform: 'facebook', href: 'https://facebook.com' },
                { id: uid(), platform: 'instagram', href: 'https://instagram.com' },
                { id: uid(), platform: 'twitter', href: 'https://twitter.com' },
                { id: uid(), platform: 'linkedin', href: '' },
                { id: uid(), platform: 'youtube', href: '' },
                { id: uid(), platform: 'tiktok', href: '' },
                { id: uid(), platform: 'pinterest', href: '' },
                { id: uid(), platform: 'github', href: '' },
                { id: uid(), platform: 'discord', href: '' },
                { id: uid(), platform: 'reddit', href: '' },
                { id: uid(), platform: 'whatsapp', href: '' },
                { id: uid(), platform: 'telegram', href: '' },
              ],
              align: 'center',
              iconSize: 24,
              padding: '10px 25px',
